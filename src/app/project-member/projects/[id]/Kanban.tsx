...
const KanbanBoard = () => {
  ...
  const [newTaskForm, setNewTaskForm] = useState({ columnId: null, isOpen: false });
  const [newColumnForm, setNewColumnForm] = useState({ isOpen: false, title: '' });
  ...
  const TaskForm = ({ columnId, onSubmit, onCancel }) => {
